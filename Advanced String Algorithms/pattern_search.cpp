// Problem link
// https://www.hackerearth.com/practice/data-structures/advanced-data-structures/suffix-arrays/practice-problems/algorithm/suffix-array-substring-occurrences/
#include <bits/stdc++.h>
...
int main() {
  ...
  // while(t--)
  {
    ...
    fu(i, foc, loc) { indpat.push_back(Sa[i]); }
    sort(all(indpat));
    rep(i, indpat.size()) {
      pl(indpat[i]);
      ps();
